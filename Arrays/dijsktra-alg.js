...
// 1. Calculate the distance between any nodes in the dataset, without
// needing to edit the problem dictionary.
// 2. Prevent algorithm from going back to start node if loops exist in graph
// (e.g., in problem below)
